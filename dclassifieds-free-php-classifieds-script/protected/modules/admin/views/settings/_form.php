...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php 
		if(!in_array($model->setting_name, $checkboxFields)){
			echo $form->textField($model,'setting_value',array('size'=>60,'maxlength'=>255)); 
		} else {
			echo $form->checkBox($model,'setting_value',array('size'=>60,'maxlength'=>255)); 
		}
		?>
