...
class AdTagController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('AdTag');
	...
	{
		$model=new AdTag('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['AdTag']))
			$model->attributes=$_GET['AdTag'];
	...
	{
		$model=AdTag::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ad-tag-form')
		{
