...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div>
		<div class="publish_left_row">
			...
			<?php echo $form->labelEx($model,'ad_title', array('label' => Yii::t('publish_page', 'Title')));?> <a href="javascript:void;" class="thelp" title="<?=Yii::t('publish_page_v2', 'Enter the title of your classified')?>">[?]</a>
			</div>
		...
		<div class="row" style="float:left; margin-left:30px; width:350px;">
			<div class="publish_label_conatiner">
			<?php echo $form->labelEx($model,'ad_type_id', array('label' => Yii::t('publish_page_v2', 'Ad Type'))); ?> <a href="javascript:void;" class="thelp" title="<?=Yii::t('publish_page_v2', 'Enter the title of your classified')?>">[?]</a>
			</div>
			<div>
	...
	<div>
		<div class="publish_left_row">
			<div class="publish_label_conatiner">
			<?php echo $form->labelEx($model,'category_id', array('label' => Yii::t('publish_page', 'Category'))); ?> <a href="javascript:void;" class="thelp" title="<?=Yii::t('publish_page_v2', 'Please select category for your classified')?>">[?]</a>
			</div>
		...
		<div class="publish_right_row">
			<div class="publish_label_conatiner">
			<?php echo $form->labelEx($model,'ad_valid_id', array('label' => Yii::t('publish_page_v2', 'Classifieds Validity Period'))); ?> <a href="javascript:void;" class="thelp" title="<?=Yii::t('publish_page_v2', 'Please select how long your classified will be active')?>">[?]</a>
			</div>
	...
	<div class="row">
		<div class="publish_label_conatiner">
		<?php echo $form->labelEx($model,'ad_description', array('label' => Yii::t('publish_page', 'Description'))); ?> <a href="javascript:void;" class="thelp" title="<?=Yii::t('publish_page_v2', 'Enter the title of your classified')?>">[?]</a>
		</div>
	...
	<div class="last_row_in_publish_section">
		<div class="publish_left_row">
			<div class="publish_label_conatiner">
			<?php echo $form->labelEx($model,'ad_price', array('label' => Yii::t('publish_page', 'Price'))); ?> <a href="javascript:void;" class="thelp" title="<?=Yii::t('publish_page_v2', 'Enter price for your classified.')?>">[?]</a>
			</div>
		...
		<div class="publish_right_row">
			<div class="publish_label_conatiner">
			<?php echo $form->labelEx($model,'ad_tags', array('label' => Yii::t('publish_page', 'Tags'))); ?> <a href="javascript:void;" class="thelp" title="<?=Yii::t('publish_page_v2', 'If you want write several keyword that describe best your classified. Devide keywords with comma (,).')?>">[?]</a>
			</div>
	...
	<div>
		<div class="publish_left_row">
			<div class="publish_label_conatiner">
			<?php echo $form->labelEx($model,'ad_email', array('label' => Yii::t('publish_page', 'E-Mail'))); ?> <a href="javascript:void;" class="thelp" title="<?=Yii::t('publish_page_v2', 'Enter contact mail for your classified. The mail will not be visible to other users.')?>">[?]</a>
			</div>
		...
		<div class="publish_right_row">
			<div class="publish_label_conatiner">
			<?php echo $form->labelEx($model,'ad_puslisher_name', array('label' => Yii::t('publish_page_v2', 'Contact Name'))); ?> <a href="javascript:void;" class="thelp" title="<?=Yii::t('publish_page_v2', 'Enter the title of your classified')?>">[?]</a>
			</div>
	...
	<div>
		<div class="publish_left_row">
			<div class="publish_label_conatiner">
			<?php echo $form->labelEx($model,'ad_phone', array('label' => Yii::t('publish_page', 'Phone'))); ?> <a href="javascript:void;" class="thelp" title="<?=Yii::t('publish_page_v2', 'Enter the title of your classified')?>">[?]</a>
			</div>
		...
		<div class="publish_right_row">
			<div class="publish_label_conatiner">
			<?php echo $form->labelEx($model,'ad_skype', array('label' => Yii::t('admin_v2', 'Skype'))); ?> <a href="javascript:void;" class="thelp" title="<?=Yii::t('publish_page_v2', 'Enter the title of your classified')?>">[?]</a>
			</div>
	...
	<div class="last_row_in_publish_section">
		<div class="publish_left_row">
			<div class="publish_label_conatiner">
			<?php echo $form->labelEx($model,'location_id', array('label' => Yii::t('publish_page', 'Location'))); ?> <a href="javascript:void;" class="thelp" title="<?=Yii::t('publish_page_v2', 'Enter the title of your classified')?>">[?]</a>
			</div>
		...
		<div class="publish_left_row" style="width: 530px;">
			<div class="publish_label_conatiner">
			<?php echo $form->labelEx($model,'ad_address'); ?> <a href="javascript:void;" class="thelp" title="<?=Yii::t('publish_page_v2', 'Type address for your classified, or click on "Find on map" to select your address from map.')?>">[?]</a>
			</div>
	...
	<div class="last_row_in_publish_section">
		<div class="publish_left_row">
			<div class="publish_label_conatiner">
			<?php echo $form->labelEx($model,'ad_link', array('label' => Yii::t('publish_page_v2', 'Web Site'))); ?> <a href="javascript:void;" class="thelp" title="<?=Yii::t('publish_page_v2', 'Enter website url in this format : http://www.site.com')?>">[?]</a>
			</div>
		...
		<div class="publish_right_row">
			<div class="publish_label_conatiner">
			<?php echo $form->labelEx($model,'ad_video', array('label' => Yii::t('publish_page_v2', 'Video'))); ?> <a href="javascript:void;" class="thelp" title="<?=Yii::t('publish_page_v2', 'Paste YouTube, Vimeo, etc. video embed code here.')?>">[?]</a>
			</div>
	...
	<div class="last_row_in_publish_section">
		<div class="publish_left_row">
			...
			//echo $form->fileField($model,'images',array('class' => "multi", 'maxlength' => "5", 'accept' => "gif|jpg|png", 'name' => 'images[]')); ?>
