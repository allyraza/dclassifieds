<div style="margin-left:10px;">
	<div style="margin:10px 0px 20px 0px">
		<form>
			...
			<input type="button" name="location_find" id="location_find" value="Find on the map" />
			<input type="button" name="location_ok" id="location_ok" value="Yes this is my location" />
		</form>
	</div>
